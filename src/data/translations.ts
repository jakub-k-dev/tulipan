...
export const gallery = {
  sk: {
    ...
    timelineTitle: 'Tulipán — nedávna história',
    backToGallery: '← Späť na galériu',
    openEvent: 'Pozrieť fotky',
    photosCount: 'fotografií',
    lightboxClose: 'Zavrieť',
    lightboxPrev: 'Predchádzajúca',
    lightboxNext: 'Ďalšia',
    videoLabel: 'Video',
    eventDetailsLabel: 'Podujatie',
    eventDate: 'Dátum',
    eventPlace: 'Miesto',
    eventTime: 'Čas',
  ...
  en: {
    ...
    timelineTitle: 'Tulipan — recent history',
    backToGallery: '← Back to gallery',
    openEvent: 'View photos',
    photosCount: 'photos',
    lightboxClose: 'Close',
